        ...
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full px-5 py-4 text-black rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-transparent"
              required
              disabled={loading}
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="••••••••"
              className="w-full px-5 text-black  py-4 rounded-xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-red-900 focus:border-transparent"
              required
              disabled={loading}
            />
          </div>
