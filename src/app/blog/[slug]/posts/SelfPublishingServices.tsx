...
export default function SelfPublishingServices() {
  return (
    <article className="max-w-3xl mx-auto space-y-10">
      {/* PASTE BODY FROM src/app/articles/self-publishing-services-ottawa/page.tsx */}
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-10">
              ...
              <p className="text-gray-600 text-sm mt-3">
                ...
                </Link> can benefit greatly from professional self-publishing services that guide them through every step.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-600 text-sm mt-3">
                ...
                </Link> provide the comprehensive support needed to bring your book to market.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-600 text-sm mt-3">
                ...
                </Link> in Ottawa provide the personalized guidance you need to succeed.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-900 to-amber-800 rounded-2xl p-8 mb-10 text-white">
              ...
              <p className="text-white/70 text-sm mt-4">
                <Link href="/articles/self-publishing-consultation-ottawa" className="text-amber-300 hover:underline">
                  Self-publishing consultation
                </Link> can help you maximize these benefits for your specific project.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-600 text-sm mt-4">
                ...
                </Link> services complement these essential publishing services.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-10 shadow-sm">
              ...
              <p className="text-gray-600 text-sm mt-3">
                <Link href="/articles/self-publishing-consultation-ottawa" className="text-red-900 hover:underline">
                  Self-publishing consultation
                </Link> can help you evaluate providers and make the right choice.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-gray-600 text-sm mt-3">
                <Link href="/articles/author-branding-book-marketing-ottawa" className="text-red-900 hover:underline">
                  Author branding and book marketing
                </Link> strategies are essential for maximizing your book's reach.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 mb-10">
              ...
              <p className="text-gray-600 text-sm mt-4">
                ...
                </Link> and other niche genres often have specialized educational resources available.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-10 shadow-sm">
              ...
              <p className="text-gray-600 text-sm mt-4">
                ...
                </Link> projects require similar wisdom and careful planning.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 mb-10 text-white">
              ...
              <p className="text-white/70 text-sm mt-4">
                ...
                </Link> is one of the many opportunities available to Ottawa authors.
              </p>
            </div>
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <p className="text-gray-600 text-sm mt-3">
                Explore our related guides: <Link href="/articles/self-publishing-consultation-ottawa" className="text-red-900 hover:underline">Self-publishing consultation</Link>, 
                ...
                <Link href="/articles/professional-book-publishing-ottawa" className="text-red-900 hover:underline"> Professional book publishing</Link>.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-red-900 to-amber-800 rounded-2xl p-8 text-center text-white mt-10">
              ...
              <Link href="/articles/self-publishing-consultation-ottawa" className="inline-block bg-white text-red-900 px-8 py-3 rounded-full font-semibold hover:shadow-lg transition">
