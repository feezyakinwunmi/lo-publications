...
export default function AuthorSupportServices() {
  return (
    <article className="max-w-3xl mx-auto space-y-10">
      {/* PASTE BODY FROM src/app/articles/author-support-services-ottawa/page.tsx */}
          ...
          <div className="p-6 md:p-10">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 mb-10">
              ...
              <p className="text-gray-600 text-sm mt-3">
                ...
                </Link> provide the professional support you need to navigate every stage of the publishing process.
              </p>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <p className="text-gray-600 text-sm mt-3">
                  ...
                  </Link> can help you navigate these obstacles and develop a clear publishing strategy.
                </p>
              </div>
            </div>
            ...
            <div className="mb-10">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 mb-4 shadow-sm">
                ...
                <p className="text-gray-600 text-sm mt-3">
                  ...
                  </Link> include comprehensive editing to ensure your manuscript is polished and publication-ready.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-red-900 to-amber-800 rounded-xl p-6 text-white">
                ...
                <p className="text-white/70 text-sm mt-3">
                  <Link href="/articles/self-publishing-services-ottawa" className="text-amber-300 hover:underline">
                    Self-publishing services in Ottawa
                  </Link> provide comprehensive support for independent authors.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-10 shadow-sm">
              ...
              <p className="text-gray-600 text-sm mt-3">
                <Link href="/articles/self-publishing-consultation-ottawa" className="text-red-900 hover:underline">
                  Self-publishing consultation
                </Link> can help you answer these questions and develop a clear publishing roadmap.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-10 shadow-sm">
              ...
              <div className="flex flex-wrap gap-3 mt-4">
                <Link href="/articles/first-time-author-publishing-ottawa" className="text-red-900 hover:underline text-sm">
                  First-time author guide
                </Link>
                <span className="text-gray-300">|</span>
                <Link href="/articles/faith-based-publishing-ottawa" className="text-red-900 hover:underline text-sm">
